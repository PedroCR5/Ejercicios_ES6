...
const filterVideogames = (videogames.filter((e) => e.genders.includes(`RPG`)))
const reduceFilterVideogames = filterVideogames.reduce((acc, s) => acc += s.score, 0) / filterVideogames.length;
console.log(reduceFilterVideogames);