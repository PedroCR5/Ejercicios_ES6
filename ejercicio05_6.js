...
function recibirInfoInput() {
  const filterWords = document.querySelector("input");
  const namesFiltered = streamers.filter((element) => element.name.includes(filterWords.value))
  console.log(namesFiltered);
}
setInterval(recibirInfoInput, 2000);
